...
12. [Сервис обертка над httpx для сбора данных о странице: статус код, заголовок, тип/длина контента, технологии (httpx_service)](app/services/httpx_service/README.md)