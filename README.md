...
6. [Сервис обертка над dnsx для активного поиска поддоменов (dnsx_service)](app/services/dast/dnsx_service/README.md)
7. [Сервис обертка над feroxbuster для сбора страниц (feroxbuster_service)](app/services/dast/feroxbuster_service/README.md)
